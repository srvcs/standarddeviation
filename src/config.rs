...
pub struct Config {
    ...
    /// Base URL of the srvcs-populationstddev dependency.
...
impl Config {
    pub fn from_vars(
        ...
        log: Option<String>,
        env: Option<String>,
        populationstddev_url: Option<String>,
    ) -> Self {
        let bind_addr = bind
        ...
        Config {
            ...
            populationstddev_url: populationstddev_url
    ...
    pub fn from_env() -> Self {
        Self::from_vars(
            ...
            std::env::var("SRVCS_POPULATIONSTDDEV_URL").ok(),
        )
    }
}
...
mod tests {
    ...
    fn defaults_are_sane() {
        ...
        assert_eq!(c.populationstddev_url, "http://127.0.0.1:8090");
    }
